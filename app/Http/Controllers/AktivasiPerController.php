...
class AktivasiPerController extends Controller
{
    ...
    public function create()
    {
        ...
        //     $perangkat = Perangkat::where('id','!=',$a->id_perangkat)->get();  
        // }
        // foreach ($aktivasi as $a) {
    ...
    public function store(Request $request)
    {
        ...
        if ($v->fails()) {
        	...
        	$data = AktivasiPerangkat::where('id_perangkat',$request->id_perangkat)->orWhere('id_ruangan',$request->id_ruangan)->exists();
        	// dd($data);
            if ($data) 
            {

...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 22, 2020 at 01:53 AM
...
(223, '98959', '1212121', '121212121', '2020-06-25', NULL, NULL, NULL, 'aktif', '2020-06-21 15:13:44', '2020-06-21 08:13:44');
...
(1, 'Admin', '983983', 'Test', '09812938902', 'IMG-1592780896-avatar3.png', 'Admin', 'admin@gmail.com', NULL, '$2y$10$wxHWnRSJ0FIYOkiHbAhvKeidiFX9S3Vwe.kq/oWUJFsnrrnF5Wcq6', NULL, '2020-06-21 16:04:31', '2020-06-21 16:08:16');
...
--
ALTER TABLE `monitoring`
  MODIFY `id_monitoring` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `monitoring`
  ADD CONSTRAINT `datapengukurans_perangkat_id_foreign` FOREIGN KEY (`perangkat_id`) REFERENCES `perangkats` (`id`) ON DELETE CASCADE,
...
--
ALTER TABLE `perangkats`
  ADD CONSTRAINT `dataperangkats_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE;
COMMIT;
